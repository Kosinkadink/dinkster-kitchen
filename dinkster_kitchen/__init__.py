...
def sol_attn(
    ...
    """
    return torch.ops.dinkster_kitchen.sol_attn(
        q, k, v, tau, scale,
...
def na3d(
    ...
    return torch.ops.dinkster_kitchen.na3d(q, k, v, kernel_size, is_causal, scale)
...
def na2d(
    ...
    out = torch.ops.dinkster_kitchen.na3d(
...
def adaln(
    ...
    """
    return torch.ops.dinkster_kitchen.adaln(x, scale, shift, eps)
...
def fp16_conv3d(
    ...
    return torch.ops.dinkster_kitchen.fp16_conv3d(x, weight, bias, residual, stride)
...
def group_norm_silu_pad3d(
    ...
    """
    return torch.ops.dinkster_kitchen.group_norm_silu_pad3d(x, weight, bias, num_groups, eps, list(pad), silu)
...
def rms_adaln(
    ...
    Returns:
        Normalized and modulated tensor with the same shape as x
    """
    return torch.ops.dinkster_kitchen.rms_adaln(x, scale, shift, eps)
...
def quantize_per_tensor_fp8(
    ...
    return torch.ops.dinkster_kitchen.quantize_fp8(x, scale, dtype_code)
...
def dequantize_per_tensor_fp8(
    ...
    """
    dtype_code = DTYPE_TO_CODE[output_type]
    return torch.ops.dinkster_kitchen.dequantize_fp8(x, scale, dtype_code)
...
def quantize_nvfp4(
    ...
    """
    return torch.ops.dinkster_kitchen.quantize_nvfp4(x, per_tensor_scale, epsilon, pad_16x, hi_first)
...
def dequantize_nvfp4(
    ...
    """
    dtype_code = DTYPE_TO_CODE[output_type]
    return torch.ops.dinkster_kitchen.dequantize_nvfp4(qx, per_tensor_scale, block_scales, dtype_code, hi_first)
...
def scaled_mm_nvfp4(
    ...
    return torch.ops.dinkster_kitchen.scaled_mm_nvfp4(
...
def quantize_mxfp8(
    ...
    """
    return torch.ops.dinkster_kitchen.quantize_mxfp8(x, pad_32x)
...
def dequantize_mxfp8(
    ...
    """
    dtype_code = DTYPE_TO_CODE[output_type]
    return torch.ops.dinkster_kitchen.dequantize_mxfp8(qx, block_scales, dtype_code)
...
def scaled_mm_mxfp8(
    ...
    if out_dtype is None:
        out_dtype = torch.bfloat16
    dtype_code = DTYPE_TO_CODE[out_dtype]
    return torch.ops.dinkster_kitchen.scaled_mm_mxfp8(
...
def quantize_svdquant_w4a4(
    ...
    """
    return torch.ops.dinkster_kitchen.quantize_svdquant_w4a4(
...
def scaled_mm_svdquant_w4a4(
    ...
    """
    return torch.ops.dinkster_kitchen.scaled_mm_svdquant_w4a4(
...
def gemv_awq_w4a16(
    ...
    Returns:
        (..., N) output tensor.
    """
    return torch.ops.dinkster_kitchen.gemv_awq_w4a16(
...
def apply_rope(
    ...
    """
    return torch.ops.dinkster_kitchen.apply_rope(xq, xk, freqs_cis)
...
def apply_rope_(
    ...
    torch.ops.dinkster_kitchen.apply_rope_(xq, xk, freqs_cis)
    return xq, xk
...
def rms_rope(
    ...
    """
    return torch.ops.dinkster_kitchen.rms_rope(q, k, freqs_cis, q_scale, k_scale, epsilon)
...
def rms_rope_(
    ...
    torch.ops.dinkster_kitchen.rms_rope_(q, k, freqs_cis, q_scale, k_scale, epsilon)
    return q, k
...
def rms_rope1(
    ...
    return torch.ops.dinkster_kitchen.rms_rope1(x, freqs_cis, scale, epsilon)
...
def rms_rope1_(
    ...
    """Apply RMSNorm and interleaved RoPE in place (inference only)."""
    torch.ops.dinkster_kitchen.rms_rope1_(x, freqs_cis, scale, epsilon)
    return x
...
def rms_rope_split_half(
    ...
    """
    return torch.ops.dinkster_kitchen.rms_rope_split_half(q, k, freqs_cis, q_scale, k_scale, epsilon, rot_dim)
...
def rms_rope_split_half_(
    ...
    """
    torch.ops.dinkster_kitchen.rms_rope_split_half_(
...
def rms_rope_split_half1(
    ...
    """
    return torch.ops.dinkster_kitchen.rms_rope_split_half1(x, freqs_cis, scale, epsilon)
...
def rms_rope_split_half1_(
    ...
    """Apply RMSNorm and split-half RoPE in place (inference only)."""
    torch.ops.dinkster_kitchen.rms_rope_split_half1_(x, freqs_cis, scale, epsilon)
    return x
...
def apply_rope1(
    ...
    Returns:
        Transformed tensor
    """
    return torch.ops.dinkster_kitchen.apply_rope1(x, freqs_cis)


def apply_rope1_(x: torch.Tensor, freqs_cis: torch.Tensor) -> torch.Tensor:
    """Apply interleaved RoPE in place (inference only)."""
    torch.ops.dinkster_kitchen.apply_rope1_(x, freqs_cis)
    return x
...
def apply_rope_split_half(
    ...
    Returns:
        Tuple of (transformed_query, transformed_key)
    """
    return torch.ops.dinkster_kitchen.apply_rope_split_half(xq, xk, freqs_cis)
...
def apply_rope_split_half_(
    ...
    torch.ops.dinkster_kitchen.apply_rope_split_half_(xq, xk, freqs_cis)
    return xq, xk
...
def apply_rope_split_half1(
    ...
    Returns:
        Transformed tensor
    """
    return torch.ops.dinkster_kitchen.apply_rope_split_half1(x, freqs_cis)
...
def apply_rope_split_half1_(
    ...
    """Apply split-half RoPE in place (inference only)."""
    torch.ops.dinkster_kitchen.apply_rope_split_half1_(x, freqs_cis)
    return x
...
def dequantize_int8_simple(q: torch.Tensor, scale: torch.Tensor) -> torch.Tensor:
    ...
    return torch.ops.dinkster_kitchen.dequantize_int8_simple(q, scale)
...
def use_backend(name: str):
    ...
    Example:
        with dinkster_kitchen.use_backend("eager"):
            result = dinkster_kitchen.quantize_per_tensor_fp8(x, scale)
    """
