...
@torch.library.custom_op("dinkster_kitchen::int8_attention", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::int8_attention_masked", mutates_args=())
...
def int8_attention(
    ...
    *,
    ...
    """
    if attn_mask is None:
        return torch.ops.dinkster_kitchen.int8_attention(
            q,
            k,
            v,
            scale,
        )
    return torch.ops.dinkster_kitchen.int8_attention_masked(
        q,
        k,
        v,
        attn_mask,
