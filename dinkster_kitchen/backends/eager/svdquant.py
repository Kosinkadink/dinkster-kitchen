...
@torch.library.custom_op("dinkster_kitchen::quantize_svdquant_w4a4", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::scaled_mm_svdquant_w4a4", mutates_args=())
