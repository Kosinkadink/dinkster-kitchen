...
@torch.library.custom_op("dinkster_kitchen::apply_rope", mutates_args=())
def _op_apply_rope(
    xq: torch.Tensor,
    xk: torch.Tensor,
    freqs_cis: torch.Tensor,
...
@torch.library.custom_op("dinkster_kitchen::rms_rope", mutates_args=())
def _op_rms_rope(
    q: torch.Tensor,
    k: torch.Tensor,
    freqs_cis: torch.Tensor,
...
@torch.library.custom_op("dinkster_kitchen::rms_rope1", mutates_args=())
def _op_rms_rope1(
    x: torch.Tensor,
    freqs_cis: torch.Tensor,
    scale: torch.Tensor,
...
@torch.library.custom_op("dinkster_kitchen::rms_rope_split_half", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::rms_rope_split_half1", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::apply_rope_", mutates_args={"xq", "xk"})
...
@torch.library.custom_op("dinkster_kitchen::apply_rope1_", mutates_args={"x"})
...
@torch.library.custom_op(
    "dinkster_kitchen::apply_rope_split_half_", mutates_args={"xq", "xk"}
)
...
@torch.library.custom_op(
    "dinkster_kitchen::apply_rope_split_half1_", mutates_args={"x"}
)
...
@torch.library.custom_op("dinkster_kitchen::rms_rope_", mutates_args={"q", "k"})
def _op_rms_rope_(
    q: torch.Tensor, k: torch.Tensor, freqs_cis: torch.Tensor,
    q_scale: torch.Tensor, k_scale: torch.Tensor | None = None,
    epsilon: float = 1e-6,
...
@torch.library.custom_op("dinkster_kitchen::rms_rope1_", mutates_args={"x"})
def _op_rms_rope1_(
    x: torch.Tensor, freqs_cis: torch.Tensor, scale: torch.Tensor,
    epsilon: float = 1e-6,
) -> None:
...
@torch.library.custom_op(
    "dinkster_kitchen::rms_rope_split_half_", mutates_args={"q", "k"}
)
...
@torch.library.custom_op(
    "dinkster_kitchen::rms_rope_split_half1_", mutates_args={"x"}
)
...
@torch.library.custom_op("dinkster_kitchen::apply_rope1", mutates_args=())
def _op_apply_rope1(
    x: torch.Tensor,
    freqs_cis: torch.Tensor,
) -> torch.Tensor:
...
@torch.library.custom_op("dinkster_kitchen::apply_rope_split_half", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::apply_rope_split_half1", mutates_args=())
