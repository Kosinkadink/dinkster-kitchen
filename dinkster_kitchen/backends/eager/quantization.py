...
from dinkster_kitchen.float_utils import (
    E8M0_BIAS,
    F4_E2M1_MAX,
    F8_E4M3_MAX,
    F8_E5M2_MAX,
...
from dinkster_kitchen.scaled_mm_v2 import ScalingType, SwizzleType, scaled_mm_v2
from dinkster_kitchen.tensor.int8_utils import _build_hadamard, _rotate_activation, _rotate_weight
...
@torch.library.custom_op("dinkster_kitchen::quantize_fp8", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_fp8", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::quantize_nvfp4", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_nvfp4", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::scaled_mm_nvfp4", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::quantize_mxfp8", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_mxfp8", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::scaled_mm_mxfp8", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::quantize_int8_tensorwise", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::quantize_int8_rowwise", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::quantize_int8_convrot_weight", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_int8_convrot_weight", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_int8_convrot_weight_dtype", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_int8_embedding", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_int8_simple", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::dequantize_int8_simple_dtype", mutates_args=())
...
@torch.library.custom_op("dinkster_kitchen::int8_linear", mutates_args=())
def _op_int8_linear(
    x: torch.Tensor,
    weight: torch.Tensor,
    weight_scale: torch.Tensor,
