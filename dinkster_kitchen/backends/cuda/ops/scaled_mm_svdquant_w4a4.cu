...
//   DINKSTER_KITCHEN_SVDQUANT_SHARED_SCALE=1 stages each CTA's 128 wscales for the
...
//
// Experimental fast path: DINKSTER_KITCHEN_SVDQUANT_FAST_ACCUM=1 dispatches a
