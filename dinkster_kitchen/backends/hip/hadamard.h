...
// dtype codes match dinkster_kitchen.backends.eager.quantization.DTYPE_TO_CODE
...
// Codes match dinkster_kitchen.backends._activations.INPUT_ACT_TO_CODE. SwiGLU is
